...
--
-- Añade a user_prefs el dedupe de los envíos nuevos:
--   - last_weekly_sent: resumen semanal del domingo
--   - last_rescue_sent: rescate tras 3+ días de inactividad
--   - last_quote_sent: push del mediodía con la cita del día
-- ============================================================
...
ALTER TABLE stoic.user_prefs ADD COLUMN IF NOT EXISTS last_quote_sent DATE;
